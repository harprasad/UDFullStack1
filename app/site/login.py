...
@mod.route('/login')
def ShowLogin():
    '''Displays login UI & sets the STATE token in the template file'''
...
def gconnect():
    '''This function fetch information from google Oauth and store it in login_session'''
...
def disconnect():
    '''This function performs the logout action & removes user details from login session'''
